...
namespace GBProd\ElasticaBundle\Tests\Client;
...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    public function testRequestsAreLogged()
    {
        ...
        $logger = $this->getMock('GBProd\ElasticaBundle\Logger\ElasticaLogger');
        $logger
            ->expects($this->once())
            ->method('logQuery')
            ->with(
        ...
        $client = $this->getMockBuilder('GBProd\ElasticaBundle\Elastica\Client')
